...
flatcode32_idx  =       30h             ; offset of 32-bit code  segment in GDT
flatdata32_idx  =       38h             ; offset of 32-bit data segment in GDT
code64_idx      =       40h             ; offset of 64-bit code segment in GDT
data64_idx      =       48h             ; offset of 64-bit data segment in GDT
stack64_idx      =      50h             ; offset of 64-bit data segment in GDT
